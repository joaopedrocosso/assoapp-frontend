...
import styles from "./AssociateWorkspaceMembershipForm.module.css";
...
const AssociateWorkspaceMembershipForm: React.FC<mainFormProps> = (props) => {
  return (
    <>
...
export default AssociateWorkspaceMembershipForm;
