...
import styles from "./AssociateWorkspacePersonalForm.module.css";
import {
...
const AssociateWorkspacePersonalForm: React.FC<mainFormProps> = (props) => {
  return (
    <>
...
export default AssociateWorkspacePersonalForm;
